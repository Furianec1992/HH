  <?php
    ...
    $query = $mysqli->query("SELECT * FROM qry_doc_list WHERE doc_type_id=6 and doc_del=0 and resource_id=" . $_SESSION['resourceid'] . " ORDER BY doc_start DESC");
...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header mdl-layout--fixed-drawer">
	...
	<div class="mdl-cell  mdl-cell--12-col">
			<div class="mdl-card__title">
				<h2 class="mdl-card__title-text">Список отпусков</h2>
			</div>
