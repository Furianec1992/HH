    ...
    while ($row = $query->fetch_array(MYSQLI_ASSOC)) {
      ...
      $subrow = $subquery->fetch_array(MYSQLI_ASSOC);
    	...
    	$docsRow = $docsRow . "<tr><td class='mdl-data-table__cell--non-numeric'>" . $row["doc_id"] . "</td>
    		...
    		<td class='mdl-data-table__cell--non-numeric'>" . $row["doc_start"] . "</td>
    		<td class='mdl-data-table__cell--non-numeric'>" . $row["doc_finish"] . "</td>
  	...
  	<div class="mdl-grid">
  	  <div class="mdl-cell  mdl-cell--12-col">
  			<div class="mdl-card__title">
  				<h2 class="mdl-card__title-text">Инструкция по заполнению</h2>
  			</div>
  			<div class="mdl-card__supporting-text">
          <iframe style="height: 6000px;" src="https://docs.google.com/document/d/1VwqRvFJiViTBxfM7OHb-g1sWQIu869S7SOoHv7yrnBQ/pub?embedded=true"></iframe>
        </div>
      </div>
    </div>
	</main>
